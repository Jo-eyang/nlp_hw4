...
def setup_wandb(args):
    wandb.init(project="t5-text-to-sql", name=args.experiment_name, config=args)
...
def initialize_optimizer(args, model):
    ...
    optimizer_grouped_parameters = [
        {"params": [p for n, p in model.named_parameters() if (n in decay_parameters and p.requires_grad)], "weight_decay": args.weight_decay},
        {"params": [p for n, p in model.named_parameters() if (n not in decay_parameters and p.requires_grad)], "weight_decay": 0.0},
    ]
